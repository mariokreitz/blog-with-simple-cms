  ...
  return (
    <div className="container mx-auto px-4 py-24">
      ...
      <ul className="index mb-8 space-y-2">
        ...
        <li>
          <a className="index-link text-blue-600 hover:underline" href="#mOverview">
      ...
      <h2 id="m3" className="text-2xl font-bold mb-4">Verantwortlicher</h2>
      <p className="mb-2">
        Vorname, Name / Firma
        <br />
        Straße, Hausnr.
      ...
      <p className="mb-8">
        E-Mail-Adresse:{" "}
        <a className="text-blue-600 hover:underline" href="mailto:vorname.name@beispielsdomain.eu">
          vorname.name@beispielsdomain.eu
        </a>
      </p>

      <h2 id="mOverview" className="text-2xl font-bold mb-4">Übersicht der Verarbeitungen</h2>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-semibold mb-2">Arten der verarbeiteten Daten</h3>
      ...
      <h3 className="text-xl font-semibold mb-2">Kategorien betroffener Personen</h3>
      <ul className="list-disc pl-6 mb-4">
        <li>Kommunikationspartner.</li>
        <li>Nutzer.</li>
      </ul>
      
      <h3 className="text-xl font-semibold mb-2">Zwecke der Verarbeitung</h3>
      ...
      <h2 id="m2427" className="text-2xl font-bold mb-4">Maßgebliche Rechtsgrundlagen</h2>
      <p className="mb-4">
      ...
      <h2 id="m27" className="text-2xl font-bold mb-4">Sicherheitsmaßnahmen</h2>
      <p className="mb-4">
      ...
      <h2 id="m24" className="text-2xl font-bold mb-4">Internationale Datentransfers</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        <a className="text-blue-600 hover:underline" href="https://www.dataprivacyframework.gov/" target="_blank" rel="noopener noreferrer">
      ...
      <h2 id="m12" className="text-2xl font-bold mb-4">
        Allgemeine Informationen zur Datenspeicherung und Löschung
      </h2>
      <p className="mb-4">
      ...
      <h2 id="m10" className="text-2xl font-bold mb-4">Rechte der betroffenen Personen</h2>
      <p className="mb-4">
      ...
      <ul className="mb-8 space-y-4">
        <li className="pl-6 border-l-4 border-gray-300 py-2">
          <strong>
      ...
      <h2 id="m225" className="text-2xl font-bold mb-4">Bereitstellung des Onlineangebots und Webhosting</h2>
      <p className="mb-4">
      ...
      <div className="mb-4 pl-4 border-l-2 border-gray-200">
        <p className="mb-2"><strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z. B.
        ...
        <p className="mb-2"><strong>Betroffene Personen:</strong> Nutzer (z. B. Webseitenbesucher,
        Nutzer von Onlinediensten).</p>
        
        <p className="mb-2"><strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres
        ...
        <p className="mb-2"><strong>Aufbewahrung und Löschung:</strong> Löschung entsprechend
        Angaben im Abschnitt "Allgemeine Informationen zur Datenspeicherung
        und Löschung".</p>
        
        <p><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs.
        1 S. 1 lit. f) DSGVO).</p>
      </div>
